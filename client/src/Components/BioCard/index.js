...
const CardExample = () => {
  return (
    <MDBRow>
      <MDBCol >
        <MDBCard rever style={{marginTop: "0px"}} >
          <MDBCardBody cascades className="text-center font-weight-bold bg-dark">
            <MDBCardText className="text-white text-left css_mxheight" style={{fontFamily:"monaco", fontWeight: "bold"}}>
                ...
                <p>OOTW, as the group is often known, bring a larger and more dynamic presence to stage than their compact lineup would suggest. Zach Jones cuts an enigmatic figure offstage quiet only to step onstage and engage the audience in an electric tour de force. Tomas exudes showmanship and precision while playing gigantic beats and seamlessly incorporating drum machines and sequencers to fill out the band’s modern sound. Conrado is a force of nature on guitar, equally comfortable playing deep, anthemic riffs or teasing out haunting, highly-technical leads.</p>
